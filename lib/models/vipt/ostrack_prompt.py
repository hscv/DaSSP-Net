...
def build_viptrack(cfg, training=True):
    ...
    # print ('---------pre-------------')
    # print ('model.backbone.norm = ', model.backbone.norm.state_dict())
    # print ('model.backbone.norm2 = ', model.backbone.norm2.state_dict())
    # print ('model.backbone.norm3 = ', model.backbone.norm3.state_dict())
    # for k,v in model.named_parameters():
        # print (k)
    # torch.save(model.backbone.norm.state_dict(), 'backbone_norm.pth')
    # raise Exception
    # model.backbone.norm2.load_state_dict(model.backbone.norm.state_dict())
    # model.backbone.norm3.load_state_dict(model.backbone.norm.state_dict())
    # print ('---------last-------------')
    # print ('model.backbone.norm = ', model.backbone.norm.state_dict())
    # print ('model.backbone.norm2 = ', model.backbone.norm2.state_dict())
    # print ('model.backbone.norm3 = ', model.backbone.norm3.state_dict())
