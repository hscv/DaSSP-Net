...
class ViPTTrack(BaseTracker):
    def __init__(self, params):
        ...
        network.load_state_dict(torch.load(self.params.checkpoint, map_location='cpu')['net'], strict=True) ## first stage
        # network.load_state_dict(torch.load(self.params.checkpoint, map_location='cpu'), strict=True) ## second stage
        self.cfg = params.cfg
